...
func TestKinematics(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			[]bezier.Point{{X: 0, Y: 0}, {X: -3, Y: 6}, {X: 22, Y: -2}, {X: 56, Y: -46}, {X: -171, Y: -42}, {X: 140, Y: 150}, {X: 0, Y: 0}},
			[]bezier.Point{{X: -3, Y: 6}, {X: 10, Y: -3}, {X: 17, Y: -22}, {X: -90, Y: 1}, {X: 103, Y: 64}, {X: -140, Y: -150}},
			[]bezier.Point{{X: 6, Y: -4}, {X: 2, Y: -6}, {X: -107, Y: 23}, {X: 48, Y: 15}, {X: -121, Y: -107}},
		},
	}
	for _, test := range tests {
...
func TestInterpolatePoints(t *testing.T) {
	tests := [][]bezier.Point{
		...
		{{X: 100, Y: 100}, {X: 400, Y: 100}, {X: 700, Y: 100}, {X: 1000, Y: 100}, {X: 1000, Y: 400}, {X: 1000, Y: 700}, {X: 1000, Y: 1000}, {X: 700, Y: 1000}, {X: 400, Y: 1000}, {X: 100, Y: 1000}, {X: 100, Y: 700}, {X: 100, Y: 400}, {X: 100, Y: 100}},
