...
func TestSeedResidencyRulingDescribesTheMultiSeedReality(t *testing.T) {
	...
	ruling := strings.Join(buildPlateInventoryLines(engraverParams, cards, oneSeedPassphraseFact(false), seedCapacityMany, false), "\n")
...
func TestRestoreDocSaysThePassphraseIsNotOnThePlates(t *testing.T) {
	...
	with := strings.Join(buildPlateInventoryLines(engraverParams, cards, oneSeedPassphraseFact(true), seedCapacityMany, false), "\n")
	without := strings.Join(buildPlateInventoryLines(engraverParams, cards, oneSeedPassphraseFact(false), seedCapacityMany, false), "\n")
