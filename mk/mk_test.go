...
var parityVectors = []vec{
	{
		...
		network: "mainnet", path: "m/48h/0h/0h/2h", fp: "aabbccdd", stubs: []string{"11223344"},
	...
	},
	{
		...
		network: "mainnet", path: "m/84h/0h/0h", fp: "deadbeef", stubs: []string{"c0ffee00"},
	...
	},
	{
		...
		network: "testnet", path: "m/48h/1h/0h/2h", fp: "10203040", stubs: []string{"778899aa"},
	...
	},
	{
		...
		network: "mainnet", path: "m/84h/0h/0h", fp: "", stubs: []string{"abcdef01"},
	...
	},
	{
		...
		network: "mainnet", path: "m/9999h/1234h/56h/7h", fp: "01020304", stubs: []string{"55667788"},
	...
	},
	{
		...
		network: "mainnet", path: "m/48h/0h/0h/2h", fp: "f00dcafe", stubs: []string{"dead0001", "dead0002", "dead0003"},
	...
	},
	{
		...
		network: "mainnet", path: "m/0h/1h/2h/3h/4h/5h/6h/7h/8h/9h", fp: "", stubs: []string{"90919293"},
